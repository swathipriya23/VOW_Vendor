...
@Component({
  selector: 'app-approverinvoicedetail-view',
  templateUrl: './approverinvoicedetail-view.component.html',
  styleUrls: ['./approverinvoicedetail-view.component.scss'],
  providers: [
...
export class ApproverinvoicedetailViewComponent implements OnInit {
  invheaderdata: any
  creditdetail: any
  debitdetail: any
